...
export class Point extends Rectangle {
    ...
    static from(event) {
        const
            touchPoints = event.changedTouches,
            x           = touchPoints ? touchPoints[0].screenX : event.screenX,
            y           = touchPoints ? touchPoints[0].screenY : event.pageY;

        // Using this.constructor to not mess with
