...
export default class MenuItem extends Widget {
    ...
    doAction(event) {
        ...
        // If we are a link with an href, activate the link on keyboard action
         ...
         * @param {Core.data.Model} record Current record if called from Grid
         * @param {Core.data.Model} column Current column if called from Grid
         * @param {Boolean} checked Current checked state for item which had `checked` config
         */
